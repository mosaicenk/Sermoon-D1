...
#define STRING_CONFIG_H_AUTHOR "Sermoon D1" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Sermoon D1"
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  // Sermoon D1 hotend PID — TODO: Run M303 E0 S200 C8 U1 and replace these values
  // Current values are Ultimaker defaults, NOT tuned for Sermoon D1 hardware.
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  // Sermoon D1 bed PID — TODO: Run M303 E-1 S60 C8 U1 and replace these values
  // Current values are from unknown source (MendelMax 120V heater), NOT tuned for Sermoon D1.
  // Ki=19.20 is excessively aggressive — causes integral windup and overshoot.
  // Expected range for Sermoon D1 24V bed: Kp~50-120, Ki~1-5, Kd~500-2000
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_FEEDRATE          { 250, 250, 5, 25 }  // X/Y reduced from 300 → less frame resonance at high speed
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_ACCELERATION      { 800, 800, 100, 5000 }  // X/Y 1000→800 (quiet), E 1000→5000 (direct drive fast retract)
...
#define DEFAULT_RETRACT_ACCELERATION  5000   // E acceleration for retracts (direct drive can handle high accel)
#define DEFAULT_TRAVEL_ACCELERATION   800    // X, Y, Z acceleration for travel (reduced from 1000 for less vibration)
...
#define INVERT_X_DIR true   //CR-U5
#define INVERT_Y_DIR false  //CR-U5
//#define INVERT_Y_DIR true  //CR-U5
#define INVERT_Z_DIR false  //CR-U5
...
// Sermoon D1 hotbed print size：295 * 275 （X * Y）
