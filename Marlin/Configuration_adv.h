 ...
 */
  ...
  #define THERMAL_PROTECTION_PERIOD 30        // Seconds (was 40 — faster runaway detection)
   ...
   * below 2.
   */
  #define WATCH_TEMP_PERIOD 20                // Seconds (was 30 — faster "heating failed" detection)
 ...
 */
  ...
  #define THERMAL_PROTECTION_BED_PERIOD 60    // Seconds (was 90 — faster runaway detection)
  #define THERMAL_PROTECTION_BED_HYSTERESIS 2 // Degrees Celsius

  /**
   * As described above, except for the bed (M140/M190/M303).
   */
  #define WATCH_BED_TEMP_PERIOD 60                // Seconds (was 90 — faster "heating failed" detection)
...
//
// Sermoon D1 optimizasyon (2026-05-23): 1024 → 512.
// 250000 baud'da 512 byte yeterli (test edildi). RAM tasarrufu ~512 byte
// (%0.8 of 64KB). 250000 baud = ~25KB/s, 512 byte tampon ~20ms.
// Gerekirse tekrar 1024'e cikar.
...
//#define EMERGENCY_PARSER  // NOT supported on STM32F1 HAL (Sermoon)
...
/**
 * Auto-report current position with M154 S<seconds>
 * (Backport from Marlin 2.1.x)
 */
//#define AUTO_REPORT_POSITION

/**
 * G60 / G61 — Save and restore current position
 * Number of memory slots (0–255). Default 0 disables.
 * (Backport from Marlin 2.1.x)
 */
#define SAVED_POSITIONS 0  // Set to 1+ to enable G60/G61

/**
 * M808 — G-code repeat markers
 * Use M808 L<count> to set a loop start, M808 (no args) to loop back.
 * (Backport from Marlin 2.1.x)
 */
...
//#define HOTEND_IDLE_TIMEOUT
  ...
  #define HOTEND_IDLE_TIMEOUT_SEC (5*60)    // (seconds) Idle timeout before reducing temperature
  #define HOTEND_IDLE_MIN_TRIGGER   180     // (°C) Minimum temperature to trigger idle protection
  #define HOTEND_IDLE_NOZZLE_TARGET   0     // (°C) Drop hotend to this target on timeout (0 = off)
  #define HOTEND_IDLE_BED_TARGET      0     // (°C) Drop bed to this target on timeout (0 = off)
#endif
...
// GCODE_MACROS_SLOTS 5 × 51 byte = ~255 byte RAM. Kullanici kitlesinin
// cogu makro kullanmaz; gerekirse acabilir.
//#define GCODE_MACROS
