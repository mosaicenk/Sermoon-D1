...
#endif
#if ANY_THERMISTOR_IS(14) // R25 = 100 kOhm, beta25 = 4092 K, 4.7 kOhm pull-up, bed thermistor
  #include "thermistor_14.h"
#endif
#if ANY_THERMISTOR_IS(15) // JGAurora A5 thermistor calibration
  #include "thermistor_15.h"
#endif
#if ANY_THERMISTOR_IS(17) // Dagoma NTC, "100k Semitec 104NT-4-R025H42G"
...
#endif
#if ANY_THERMISTOR_IS(22) // beta25 = 4100 K, R25 = 100 kOhm, Pull-up = 4.7 kOhm, MakerBot Replicator 2 thermistor
  #include "thermistor_22.h"
#endif
#if ANY_THERMISTOR_IS(23) // beta25 = 4100 K, R25 = 100 kOhm, Pull-up = 4.7 kOhm, MakerBot Replicator 2 v2 thermistor
  #include "thermistor_23.h"
#endif
#if ANY_THERMISTOR_IS(30) // Kis3d Silicone heating mat 200W/24V with PT100 (Beta 3950)
...
#endif
#if ANY_THERMISTOR_IS(202) // 200K thermistor, MGB18-200K3950B1 (Tronxy X5S)
  #include "thermistor_202.h"
#endif
#if ANY_THERMISTOR_IS(331) // Like table 1, but with 3V3 as input voltage
  #include "thermistor_331.h"
#endif
#if ANY_THERMISTOR_IS(332) // Like table 1, but with 3V3 as input voltage and pull-up 10K (Hephestos 2)
  #include "thermistor_332.h"
#endif
#if ANY_THERMISTOR_IS(502) // Zonestar 100K
  #include "thermistor_502.h"
#endif
#if ANY_THERMISTOR_IS(503) // Zonestar 100K Bed (low-temp)
  #include "thermistor_503.h"
#endif
#if ANY_THERMISTOR_IS(504) // Zonestar 100K (P802QR2)
  #include "thermistor_504.h"
#endif
#if ANY_THERMISTOR_IS(505) // Zonestar 100K with 3950 NTC bed
  #include "thermistor_505.h"
#endif
#if ANY_THERMISTOR_IS(68) // PT100 with INA826 amp on Ultimaker v2.0 electronics, 3v3 input
...
#endif
#if ANY_THERMISTOR_IS(2000) // Beta 3950, 100k thermistor (Hostprt) Bed
