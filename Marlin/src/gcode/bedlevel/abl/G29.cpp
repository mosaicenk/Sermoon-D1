...
G29_TYPE GcodeSuite::G29() {
  ...
  #else // !PROBE_MANUALLY
  {
    ...
    measured_z = 0;
      ...
      for (PR_OUTER_VAR = 0, showcount = 0; PR_OUTER_VAR < PR_OUTER_END && !isnan(measured_z); PR_OUTER_VAR++) {
        ...
        for (PR_INNER_VAR = inStart; PR_INNER_VAR != inStop; pt_index++, PR_INNER_VAR += inInc) {
          ...
          if (isnan(measured_z)) {
            ...
            z_values[meshCount.x][meshCount.y] = measured_z + zoffset;
              ...
              rtscheck.RTS_SndData(z_values[meshCount.x][meshCount.y]*1000, AutolevelVal + (showcount-1)*2);
            #endif
